 ...
 *
 * This is a diagnostic kept for provenance, not part of the build. It needs the
 * original EGFRpred distribution's jars, which are not vendored here:
 *
 *   LEGACY=/path/to/egfrpred-legacy
 *   javac -cp "$LEGACY/lib/libPaDEL-Descriptor.jar:$LEGACY/lib/*" -d /tmp/probe Probe.java
 *   java  -cp "/tmp/probe:$LEGACY/lib/libPaDEL-Descriptor.jar:$LEGACY/lib/*" Probe
 */
